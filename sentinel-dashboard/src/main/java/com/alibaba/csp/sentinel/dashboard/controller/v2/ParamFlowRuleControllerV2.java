...
public class ParamFlowRuleControllerV2 {
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            List<ParamFlowRuleEntity> entities = new ArrayList<>();
    ...
    private void publishRules(/*@NonNull*/ String app) throws Exception {
        List<ParamFlowRuleEntity> entities = repository.findAllByApp(app);
        if (entities != null) {
            List<ParamFlowRule> rules = new ArrayList<>(entities.size());
            for (ParamFlowRuleEntity entity : entities) {
